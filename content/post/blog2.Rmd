...
### Future Uses
In another blog post sometime, I am going to use the data I collected to run an isolation forest algorithm to detect outlier properties in Durham. These outliers could be due to errors in data input (the county website has a disclaimer regarding this), human error in the assessment or data input for this property, or particularly odd features of a parcel. More on this later. 
