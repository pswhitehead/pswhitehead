...
#### What does this mean?
* Most people (I hope) won't be surprised (but dissapointed) to see that the percent of White applicants with approved loan applications is higher than any other racial demographic. This is especially true for Black applicants and American Indian/Alaska Native applicants. 
...
* This leads us to further questions we might want to start asking (and that some academics/researchers can answer[see](#reading-list)); why are Black and American Indian/Alaska Native applicants being denied at higher rates than White applicants for no stated reasons?
</br></br>
...
#### Step 1
We are still connected to the database, so now we can just send another SQL query. Remember our question is if income of accepted loan applications differs based on race.
</br></br>
...
#### Step 2
Now let's plot the results of the SQL query.
```{r}
